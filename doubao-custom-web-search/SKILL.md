...
python -X utf8 "scripts/doubao_search.py" --query "北京最新天气" --type web --count 5 --need-content --need-url
python -X utf8 "scripts/doubao_search.py" --query "北京故宫" --type image --count 5 --image-shapes 横长方形
```
